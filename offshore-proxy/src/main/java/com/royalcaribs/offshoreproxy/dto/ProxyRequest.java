...
/**
 * Represents an HTTP request that will be sent through the TCP tunnel. Sends
 * JSON from ship to shore.
 */
public class ProxyRequest {
	...
	@JsonCreator
	public ProxyRequest(@JsonProperty("requestId") String requestId, @JsonProperty("method") String method,
			@JsonProperty("url") String url, @JsonProperty("headers") Map<String, String> headers,
	...
	public String toString() {
		return String.format("ProxyRequest{id='%s', method='%s', url='%s', timestamp=%d}", requestId, method, url,
				timestamp);
	}
}
